...
namespace ModelBasedApproach.fonts
{
    public class EmployeeModelsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,Ename,Esalary,EmailId")] EmployeeModel employeeModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,Ename,Esalary,EmailId")] EmployeeModel employeeModel)
        {
            if (ModelState.IsValid)
            {
